...
SECRET_KEY = 'django-insecure-)(sam*lik&rx#wck9=s9b6hdx1#2=o1^hxf$x^i1=&%se2c%g)'
...
LOGGING = {
    ...
    'root': {
        'handlers': ['console'],
        'level': 'WARNING',  # Altere para INFO, ERROR ou DEBUG conforme desejar
    },
...
EMAIL_FALE_CONOSCO = 'gs808894@gmail.com'
